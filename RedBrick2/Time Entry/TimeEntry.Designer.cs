namespace RedBrick2.Time_Entry {
	partial class TimeEntry {
		...
		private void InitializeComponent() {
			...
			this.groupBox1.Controls.Add(this.total_label);
			this.groupBox1.Controls.Add(this.listView1);
			this.groupBox1.Controls.Add(this.uid_cbx);
			...
			// uid_cbx
			// 
			this.uid_cbx.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.uid_cbx.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest;
			this.uid_cbx.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
			...
			this.tableLayoutPanel2.Controls.Add(this.cust_cbx, 0, 1);
			this.tableLayoutPanel2.Controls.Add(this.proj_cbx, 0, 3);
			this.tableLayoutPanel2.Controls.Add(this.proc_cbx, 0, 5);
			this.tableLayoutPanel2.Controls.Add(this.dateTimePicker1, 0, 7);
			this.tableLayoutPanel2.Controls.Add(this.dateTimePicker2, 1, 7);
			...
			this.tableLayoutPanel2.SetColumnSpan(this.cust_cbx, 2);
			...
			// proj_cbx
			// 
			this.proj_cbx.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.tableLayoutPanel2.SetColumnSpan(this.proj_cbx, 2);
			...
			// proc_cbx
			// 
			this.proc_cbx.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.tableLayoutPanel2.SetColumnSpan(this.proc_cbx, 2);
			...
			this.tableLayoutPanel3.Controls.Add(this.add_proj_cbx, 1, 0);
			this.tableLayoutPanel3.Controls.Add(this.label12, 2, 0);
			this.tableLayoutPanel3.Controls.Add(this.cust_tb, 3, 0);
			this.tableLayoutPanel3.Controls.Add(this.descr_tb, 1, 1);
			this.tableLayoutPanel3.Controls.Add(this.dateTimePicker3, 1, 2);
			this.tableLayoutPanel3.Controls.Add(this.add_proc_cbx, 1, 3);
			this.tableLayoutPanel3.Controls.Add(this.hrs_tbx, 1, 4);
			this.tableLayoutPanel3.Controls.Add(this.clear_btn, 3, 4);
			this.tableLayoutPanel3.Controls.Add(this.add_btn, 4, 4);
			...
			// add_proj_cbx
			// 
			this.add_proj_cbx.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest;
			this.add_proj_cbx.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
			this.add_proj_cbx.DataSource = this.sCHPROJECTSBindingSource1;
			this.add_proj_cbx.DisplayMember = "DisplayName";
			...
			// cust_tb
			// 
			this.cust_tb.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tableLayoutPanel3.SetColumnSpan(this.cust_tb, 2);
			...
			// descr_tb
			// 
			this.descr_tb.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tableLayoutPanel3.SetColumnSpan(this.descr_tb, 4);
			...
			// add_proc_cbx
			// 
			this.add_proc_cbx.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest;
			this.add_proc_cbx.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
			this.add_proc_cbx.DataSource = this.sCHPROCESSBindingSource1;
			this.add_proc_cbx.DisplayMember = "PROCESS";
		...
		private System.Windows.Forms.ComboBox uid_cbx;
		private TimeEntryDataSet timeEntryDataSet;
		private System.Windows.Forms.BindingSource gENUSERSBindingSource;
		private TimeEntryDataSetTableAdapters.GEN_USERSTableAdapter gEN_USERSTableAdapter;
		...
		private TimeEntryDataSetTableAdapters.GEN_CUSTOMERSTableAdapter gEN_CUSTOMERSTableAdapter;
		...
		private TimeEntryDataSetTableAdapters.TopCustomersTableAdapter topCustomersTableAdapter;
		...
		private System.Windows.Forms.ComboBox add_proj_cbx;
		...
		private System.Windows.Forms.ComboBox add_proc_cbx;
		private System.Windows.Forms.TextBox hrs_tbx;
		private System.Windows.Forms.BindingSource sCHPROCESSBindingSource1;
